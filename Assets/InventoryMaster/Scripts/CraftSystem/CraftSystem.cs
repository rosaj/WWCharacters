...
public class CraftSystem : MonoBehaviour
{
    ...
    public void backToInventory()
    {
        ...
        {
            PlayerManager.Player.GetComponent<PlayerInventory>().inventory.GetComponent<Inventory>().addItemToInventory(itemInCraftSystem[i].itemID, itemInCraftSystem[i].itemValue);
